        ...
        {!showManual ? (
          <div className="space-y-4">
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center gap-3 p-4 border-2 border-cyan-600 rounded-xl hover:bg-gradient-to-r hover:from-cyan-50 hover:to-blue-50 transition-all disabled:opacity-50 shadow-md hover:shadow-lg"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-4 border-2 border-gray-300 rounded-xl hover:bg-gray-50 hover:border-cyan-400 transition-all shadow-sm hover:shadow-md"
            >
            ...
            {location && (
              <div className="mt-6 p-4 bg-gradient-to-r from-cyan-50 to-blue-50 border border-cyan-200 rounded-xl shadow-sm">
          ...
          <form onSubmit={handleManualSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                maxLength={6}
                pattern="[0-9]{6}"
                className="w-full px-6 py-4 text-center text-2xl font-bold border-2 border-cyan-300 rounded-xl focus:ring-2 focus:ring-cyan-600 focus:border-cyan-600 shadow-md tracking-widest"
                autoFocus
              />
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 font-medium transition-all shadow-sm"
              >
                Back
              </button>
              <button
                ...
                className="flex-1 px-4 py-3 bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-600 text-white rounded-xl hover:shadow-xl font-medium transition-all shadow-md hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                Confirm
              </button>
            </div>
